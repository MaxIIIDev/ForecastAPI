    ...
    public class RequestServicesToAPIWeather : IRequestServicesToAPIWeather
    {
        ...
        public async Task<Root> GetDataFromAPI(double lat, double lon)
        {
            ...
            try
            {
                ...
                string fullURL = $"{BASEURL}{urlFragmentWithLatAndLonReadyToGo}&days=5&dt={actualDate}&{APIKEY}"; //URL PREPARADA PARA LANZAR LA LLAMADA
        ...
        public async Task<Root> GetDataFromAPI(string cityName)
        {
            ...
            try
            {
                ...
                string fullURL = $"{BASEURL}{urlFragmentWithCityNameReadyToGo}&days=5&dt={actualDate}&{APIKEY}"; //URL PREPARADA PARA LANZAR LA LLAMADA
